...
public class GuiFixConnecting extends GuiScreen {
    ...
    public GuiFixConnecting(GuiScreen p_i1181_1_, @NotNull Minecraft mcIn, ServerData p_i1181_3_) {
        this.mc = mcIn;
    ...
    public GuiFixConnecting(GuiScreen p_i1182_1_, @NotNull Minecraft mcIn, String hostName, int port) {
        this.mc = mcIn;
    ...
    private void connectServerData(final @NotNull ServerData serverData) {
